...
public class DemoDataGenerator {
    ...
    private final List<Meeting> MEETING_LIST = List.of(
            new Meeting("Code like a Boss", "L.Torvalds", "E.Mask, M.Zuckerberg",0L),
            new Meeting("Geek out with Open Source", "R.Stallman", "J.Bezos",0L),
            new Meeting("The future of Open Source Infrastructure", "S.Hykes", "T.Hicks, P.Cormier",0L),
            new Meeting("DevOps party", "R.Stallman", "T.Hicks, T.Cook",0L));
    @Inject
